...
client.on('message', msg => {
   ...
   client.on('message', msg => {
       ...
       if(/*msg.member.id === '284889295125479425' && */ msg.content.match(/[u||U||Ù||Û||Ü||ù||ú||û||ü||ð||°||◦||θ||δ||ο||σ||o||O||0||Θ||Ò||Ó||Ô||Õ||Ö||Ø||Θ||Φ||*||©️||®||.||•||()||@||Q||q||9][^A-Za-z0-9]*[w||W||ψ||ω||Ψ][^A-Za-z0-9]*[u||U||Ù||Û||Ü||ù||ú||û||ü||ð||°||◦||θ||δ||ο||σ||o||O||0||Θ||Ò||Ó||Ô||Õ||Ö||Ø||Θ||Φ||*||©️||®||.||•||()||@||Q||q||9]/g)){
